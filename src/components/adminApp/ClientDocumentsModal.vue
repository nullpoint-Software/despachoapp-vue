...
@media(max-width:760px){.documents-modal{max-height:92dvh}.documents-body{grid-template-columns:1fr;max-height:calc(92dvh - 8.5rem)}.upload-section{border-right:0;border-bottom:1px solid var(--br-line)}.documents-modal>header{gap:1rem}.document-rows article{grid-template-columns:auto minmax(0,1fr)}.document-actions{grid-column:1/-1;justify-content:flex-end}}
