<template>
  <main ref="pageRef" class="tasks-page">
    <header class="tasks-hero">
      <div>
        <p>OPERACIÓN / 03</p>
        <h1>Tareas</h1>
        <span>Control de trabajo por estado y responsable.</span>
      </div>
      <div class="hero-mark">
        <i class="pi pi-check-square" /><span>Flujo activo</span>
      </div>
    </header>
    <section id="kanban-board" class="board-frame"><KanbanBoard /></section>
  </main>
</template>
...
useBrutalMotion(pageRef, [".tasks-hero", ".board-frame"]);
onMounted(() => {
...
.tasks-hero h1 {
  margin: 0;
  font:
    900 clamp(3.5rem, 9vw, 7rem)/0.75 Arial,
    sans-serif;
