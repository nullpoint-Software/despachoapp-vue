...
@media(max-width:700px){.ticket-printer-overlay{align-items:stretch;justify-content:stretch;padding:0}.ticket-printer-modal{display:flex;width:100vw;height:100dvh;max-height:100dvh;flex-direction:column;overflow:hidden;border:0;border-radius:0;box-shadow:none}.ticket-printer-modal>div:not(.actions){min-height:0;flex:1;overflow:auto}.ticket{max-width:100%;width:100%;margin:0}.actions{display:grid;grid-template-columns:1fr;flex-shrink:0;padding:1rem}}
</style>
