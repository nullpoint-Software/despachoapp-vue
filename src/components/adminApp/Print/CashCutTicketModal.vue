...
@media(max-width:700px){.thermal-overlay{place-items:stretch;padding:0}.thermal-modal{display:flex;width:100vw;max-width:none;height:100dvh;max-height:100dvh;flex-direction:column;border:0;box-shadow:none}.thermal-modal>header,footer{flex-shrink:0}.thermal-body{min-height:0;flex:1;overflow:auto}.ticket-preview{max-width:100%;width:100%;margin:0}footer{display:grid;grid-template-columns:1fr}}
</style>
