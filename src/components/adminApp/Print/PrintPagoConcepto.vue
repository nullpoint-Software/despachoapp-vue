...
@media(max-width:700px){.ticket-printer-overlay{align-items:stretch;justify-content:stretch;padding:0}.ticket-printer-modal{display:flex;width:100vw;max-width:none;height:100dvh;max-height:100dvh;flex-direction:column;overflow:hidden;border:0;box-shadow:none}.ticket-modal-header,.actions{flex-shrink:0}.ticket-modal-body{min-height:0;flex:1;overflow:auto}.ticket{width:100%;max-width:100%;margin:.75rem 0 0}.actions{display:grid;grid-template-columns:1fr;padding:1rem}}
</style>
