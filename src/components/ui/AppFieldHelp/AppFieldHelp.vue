...
.app-field-help__trigger {
  ...
  color: inherit;
  padding: 0;
  font: 900 0.7rem/1 var(--font-family);
  cursor: help;
}
.app-field-help__trigger:hover,
.app-field-help__trigger:focus-visible {
...
.app-field-help__popover strong {
  color: var(--br-accent) !important;
  font: 900 0.68rem/1.2 var(--font-family) !important;
  text-transform: uppercase;
}
.app-field-help__popover > span {
  color: var(--br-text) !important;
  font: 600 0.72rem/1.45 var(--font-family) !important;
  letter-spacing: 0 !important;
  text-transform: none !important;
}
.field-help-enter-active,
.field-help-leave-active {
  transition:
    opacity 0.14s ease,
    transform 0.14s ease;
}
.field-help-enter-from,
.field-help-leave-to {
  opacity: 0;
